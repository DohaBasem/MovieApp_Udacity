...
*/
    ...
    public void insertToFav(SQLiteDatabase db,Movie movie){
        ...
        final String ADD_MOVIE_TO_FAV_QUERY="INSERT INTO "+MovieDBContract.MovieInfoContract.MOVIE_TABLE_NAME+"("+MovieDBContract.MovieInfoContract.COLUMN_NAME_Movie_NAMES
